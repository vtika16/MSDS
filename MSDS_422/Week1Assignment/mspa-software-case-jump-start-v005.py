...
# Let's compare the distribution of each tool for personal, professional
...
#sns.distplot(personal['My_Java'], hist=False, rug=True)
#sns.distplot(personal['My_JS'], hist=False, rug=True)
#sns.distplot(personal['My_Python'], hist=False, rug=True)
#sns.distplot(personal['My_R'], hist=False, rug=True)
#sns.distplot(personal['My_SAS'], hist=False, rug=True)

#sns.plt.show()

for col in personal:
    sns.kdeplot(personal[col], shade=True).savefig("kdeplotPerosnal")
